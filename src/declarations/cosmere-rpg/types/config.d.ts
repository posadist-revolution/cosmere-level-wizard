import { Size, CreatureType, Status, InjuryType, AttributeGroup, Attribute, Skill, Resource, WeaponType, WeaponId, ArmorId, ExpertiseType, WeaponTraitId, ArmorTraitId, AdversaryRole, DeflectSource, ActivationType, ItemConsumeType, ActionType, ActionCostType, AttackType, DamageType, ItemType, ItemRechargeType, ItemUseType, EquipType, HoldType, EquipHand, PathType, EquipmentType, PowerType, Theme, MovementType, ImmunityType } from './cosmere';
import { AdvantageMode } from './roll';
import { Talent, TalentTree, EventSystem as ItemEventSystem } from './item';
import { AnyObject } from './utils';
import { ItemListSection, DynamicItemListSectionGenerator } from './application/actor/components/item-list';
            ...
            components: {
                actions: {
                    sections: {
                        ...
                        dynamic: Record<string, DynamicItemListSectionGenerator>;
                    };
                };
            };
        };
